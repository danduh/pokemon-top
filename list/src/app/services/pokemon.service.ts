...
export class PokemonService {
  ...
  public pokemons:BehaviorSubject<BetterPokemon[]> = new BehaviorSubject([] as BetterPokemon[])
  ...
  handlePokemonIds(typePokemons:TypePokemon[] | NamedAPIResource[]): BetterPokemon[]{
